...
export function InfoTab({
      ...
      <CardHeader>
        ...
        <Accordion type="single" collapsible defaultValue="item-1">
          <AccordionItem value="item-1">
            <AccordionTrigger>How do I get my Discord token?</AccordionTrigger>
            <AccordionContent>
              <p className="mb-2">
                Open Discord in your browser, press CTRL SHIFT + I to open
                developer tools, go to the Console tab, and paste this script:
              </p>
  ...
  token);`}
              ...
              <p className="mb-2">You may need to type allow pasting.</p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Check out the network tab in your browser&apos;s developer tools.
              The data is never sent to any servers not by discord.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              <Link href="https://github.com/y4gg/dc-cleaner-web">GitHub</Link>.
            </AccordionContent>
          </AccordionItem>
